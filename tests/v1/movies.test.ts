...
const mockFetchSequence = (
  ...
  jest.spyOn(global, 'fetch').mockImplementation((input) => {
    ...
    console.log('FETCH', callCount, typeof input === 'string' ? input : 'non-string');
    return Promise.resolve(responses[callCount++] as unknown as Awaited<ReturnType<typeof fetch>>);
  });
};
